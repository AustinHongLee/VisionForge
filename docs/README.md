...
| [VisionForge_AI分工協議_v1.md](00-法規/VisionForge_AI分工協議_v1.md) | 法規 | v1 | 🟩 定案 | Claude／Codex 分工邊界、規格票制、紅線 |
...
| [票-0001-UI殼與Bridge.md](06-規格票/票-0001-UI殼與Bridge.md) | 規格票 | — | 🟨 已發出 | 第一張 Codex 票：Electron 殼＋Bridge 抽象層 |
