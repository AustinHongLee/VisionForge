...
| [ADR-0008-VisionProvider抽象.md](02-ADR/ADR-0008-VisionProvider抽象.md) | ADR | — | 🟨 提案 | Provider 抽象：能力聲明契約（穩定）＋invoke 介面 provisional（不凍結，A10 接滿 3 家再固化）＋輸出正規化/校準為核心（R2 §6）；**合併即視同採納** |
...
| [票-0007-app-media查詢服務.md](06-規格票/票-0007-app-media查詢服務.md) | 規格票 | — | 🟨 已發出 | L0 免審：list_media 分頁＋get_media＋thumbnail_path，建於 iter_recent（app/ 白名單） |
