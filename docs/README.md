...
| [票-0012-app-process-media.md](06-規格票/票-0012-app-process-media.md) | 規格票 | — | 🟨 已發出 | L0 免審：process_media 跑 provider→core orchestrator 入帳存 run＋POST /process（審核飛輪 #1 app 側，建於 record_inference_run） |
